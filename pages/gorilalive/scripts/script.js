...
const h1Black = document.getElementsByClassName('header__content_logo_title_link');
const pBlack = document.getElementsByTagName('p');
const navBlack = document.getElementsByClassName('header__nav_item_link');
const darkBg = document.getElementsByClassName('darkBg');
const navActive = document.getElementsByClassName('activehead');
